...
class InitServiceLoaderMixin:
    ...
    def _load_text_encoder_and_tokenizer(self, *, checkpoint_dir: str, device: str, attn_implementation: str = "eager") -> str:
        """Load text tokenizer and embedding model.
        
        Args:
            checkpoint_dir: Checkpoint directory path
            device: Target device
            attn_implementation: Attention implementation to use (must match DiT
                model to avoid SDPA NaN on Blackwell GPUs)
        """
